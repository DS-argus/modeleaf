...
private enum ExactPrefixSafetyPolicy {
    static func isForbidden(_ descriptor: ActionDescriptor) -> Bool {
        ...
        case .tabNext, .tabPrevious,
             ...
             .paletteOpen, .helpShow, .documentCopyPath, .documentRevealInFinder,
             ...
             .tocToggle, .tocScrollDown, .tocScrollUp, .paneSplitRight, .paneSplitDown, .paneFocusLeft, .paneFocusDown,
